...
B.branch_view_id||K.event_data.branch_view_data.id,K.event_data.branch_view_data,E,K.journey_link_data):((K.auto_branchify||!n&&Ka("branchify_url")&&X(g))&&this.branch.deepview({},{make_new_link:!1,open_app:!0,auto_branchify:!0}),P(U,"willNotShowJourney")));x&&(sa=!0)})})}function f(q){p&&(q.identity=g.m);return q}function m(q){var r={sdk:"2.63.0",branch_key:g.o},B=O(g.h)||{},E=O(g.h,!0)||{};E.browser_fingerprint_id&&(r._t=E.browser_fingerprint_id);Ia()||Ja()||g.i(jb,r,function(K,Ha){K&&(g.u=3,g.B=
