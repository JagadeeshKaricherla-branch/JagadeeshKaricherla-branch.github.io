...
// Input 2
var config = {app_service_endpoint:"https://app.link", link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api.stage.branch.io", version:"2.80.0"};
// Input 3
...
journeys_utils.setPositionAndHeight = function(a) {
  ...
  if (b && b.bannerHeight && b.position && (b.sticky || "inject" === b.position)) {
    journeys_utils.bannerHeight = b.bannerHeight, journeys_utils.position = "inject" === b.position ? "bottom" : b.position, journeys_utils.sticky = b.sticky ? b.sticky : "fixed";
  } else {
