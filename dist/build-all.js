...
// Input 2
var config = {app_service_endpoint:"https://app.link", link_service_endpoint:"https://bnc.lt", api_endpoint:"https://api2.branch.io", version:"2.76.0"};
// Input 3
...
Branch.prototype.setIdentity = wrap(callback_params.CALLBACK_ERR_DATA, function(a, b) {
  if (b) {
    var c = {identity_id:this.identity_id, session_id:this.session_id, link:this.sessionLink};
    this.identity = b;
...
Branch.prototype.logout = wrap(callback_params.CALLBACK_ERR, function(a) {
  var b = {data_parsed:null, data:null, referring_link:null, referringLinkExpiry:null, click_id:null, link_click_id:null, identity:null, session_id:this.session_id, identity_id:this.identity_id, link:this.sessionLink || null, device_fingerprint_id:this.device_fingerprint_id || null};
  this.identity = null;
  session.patch(this._storage, b, !0, !0);
  a(null);
});
